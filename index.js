...
var diff = resemble('.resources/note1.jpg').compareTo('.resources/note.jpg').ignoreColors().onComplete(function(data){
    console.log(data);
  }
);
var diff = resemble('.resources/note1.jpg').compareTo('.resources/cat.jpg').ignoreColors().onComplete(function(data){
    console.log(data);
  }
);
var diff = resemble('.resources/note1.jpg').compareTo('.resources/note100.jpg').ignoreColors().onComplete(function(data){
    console.log(data);
  }
);
var diff = resemble('.resources/note100x2.jpg').compareTo('.resources/note100.jpg').ignoreColors().onComplete(function(data){
    console.log(data);
  }
);
var diff = resemble('.resources/note100cam.jpg').compareTo('.resources/note100x2.jpg').ignoreColors().onComplete(function(data){
    console.log(data);
  }
);
var options =  {
...
//var GoogleTTS = require('google-tts');
//let AbbyyClient=require('nodejs-ocr');
>>>>>>> 8a811d03e51cc44203e138dadbd32bda6385d1fa
